...
const breakpoints = {
  320: { slidesPerView: 1, spaceBetween: 36 },
  576: { slidesPerView: 2, spaceBetween: 36 },
  ...
  return (
    <div>
      ...
      <Container className="my-8">
        <Link href="/muzeys" className="inline-block my-6 text-2xl font-normal ">
          {t("navbar:muzeys")}
        </Link>
        <Slider slidesPerView={3} spaceBetween={50} className="my-4" breakpoints={breakpoints}>
          {muzeys.map((slide) => (
        ...
        <Link href="/genders" className="inline-block my-6 text-2xl font-normal ">
          {t("navbar:genders")}
        </Link>
        ...
        <Link href="/jadids" className="inline-block my-6 text-2xl font-normal ">
          {t("navbar:jadids")}
        </Link>
        <Slider slidesPerView={3} spaceBetween={50} breakpoints={breakpoints}>
          {jadids.map((slide) => (
